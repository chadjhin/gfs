...
$fromadminset = $_GET['fromadminset'];
...
if($err)
{
  ...
  if($access_token)
  {
    ...
    header("Location: cancel_sub.php?access_token=".$access_token."&subscriberID=".$subscriberID."&&fromadminset=".$fromadminset."&&user_id=".$fromadminset."");
