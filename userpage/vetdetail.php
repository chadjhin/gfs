...
{ 
  $_SESSION['vetname']=$_GET['prodname'];
...
//$userprofile = new firestore(collection:'petstore');
      ...
      $docRef = $db->collection('vetclinic')->document($userid22)->collection('vets')->document($_SESSION['vetname']);
...
<body class="user-profile" id="loadvetpage">
...
<?php
            if(isset($_GET['userid']))
            {
              print_r("<a class='btn btn-info float-right' id='list' name='list' href='listofvets.php?userid=".$userid22."&usertype=".$num."'>Vet List</a>");
            
            }
            else  if(isset($_SESSION['user_id']))
            {
              print_r("<a class='btn btn-info float-right' id='list' name='list' href='listofvets.php'>Vet List</a>");
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            ...
            <a class="navbar-brand" href="#" style="size:50px;">Veterinarian of, <?PHP printf($iduser)?></a>
            </li>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        Schedule
                          ...
                          <input   id="demo-time"data-label-style="stacked" name="Sundaytime" style="width:50%; margin-left:35px;" type="hidden" value="<?php print_r($snapshot->data()['Sunday']) ?>" placeholder="Please select..." /><br>
                          <input  style="margin-left:25px;" type="checkbox" id="Monday" name="week" value="Monday" onchange= chk_onchange2();>
                          <label for="Monday"> Monday</label>
                          <input  name="Mondayt" id="demo-time" style="width:50%; margin-left:32px;" type="hidden"  value="<?php print_r($snapshot->data()['Monday']) ?>" placeholder="Please select..." /><br>
                          ...
                          <input  id="demo-time" style="width:50%; margin-left:31px;"name="Tuesdaytime" type="hidden"  value="<?php print_r($snapshot->data()['Tuesday']) ?>"placeholder="Please select..." /><br>
                          <input  style="margin-left:25px;" type="checkbox" id="Wednesday" name="week" value="Wednesday" onchange= chk_onchange4();>
                          <label for="Wednesday"> Wednesday</label>
                          <input  id="demo-time" style="width:50%; margin-left:10px;"name="Wednesdaytime" type="hidden"  value="<?php print_r($snapshot->data()['Wednesday']) ?>"placeholder="Please select..." /><br>
                      </div>
                    </div>
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>
                          ...
                          <input  id="demo-time" style="width:50%; margin-left:8px;"name="Thursdaytime"  type="hidden"  value="<?php print_r($snapshot->data()['Thursday']) ?>"placeholder="Please select..." /><br>
                          <input  style="margin-left:25px;" type="checkbox" id="Friday" name="week" value="Friday" onchange= chk_onchange6();>
                          <label for="Friday"> Friday</label>
                          <input  id="demo-time" style="width:50%; margin-left:27px;"name="Fridaytime" type="hidden"  value="<?php print_r($snapshot->data()['Friday']) ?>"placeholder="Please select..." /><br>
                          <input  style="margin-left:25px;" type="checkbox" id="Saturday" name="week" value="Saturday" onchange= chk_onchange7();>
                          <label for="Saturday"> Saturday</label>
                          <input  id="demo-time" style="width:50%; margin-left:10px;"name="Saturdaytime" type="hidden"  value="<?php print_r($snapshot->data()['Saturday']) ?>"placeholder="Please select..." /><br>
                    ...
                    <script type="text/javascript">
                      ...
                      document.querySelector("[name='Sundaytime']").required = "false";
                        document.querySelector("[name='Sundaytime']").value = "";
                      //chckbox--;
                      }
                      ...
                      document.querySelector("[name='Mondayt']").required = "false";
                        document.querySelector("[name='Mondayt']").value = "";
                      //chckbox--;
                      }
                      ...
                      document.querySelector("[name='Tuesdaytime']").required = "false";
                        document.querySelector("[name='Tuesdaytime']").value = "";
                      //chckbox--;
                      }
                      ...
                      document.querySelector("[name='Wednesdaytime']").required = "false";
                        document.querySelector("[name='Wednesdaytime']").value = "";
                      //chckbox--;
                      }
                      ...
                      document.querySelector("[name='Thursdaytime']").required = "false";
                        document.querySelector("[name='Thursdaytime']").value = "";
                      //chckbox--;
                      }
                      ...
                      document.querySelector("[name='Fridaytime']").required = "false";
                        document.querySelector("[name='Fridaytime']").value = "";
                      //chckbox--;
                      }
                      ...
                      document.querySelector("[name='Saturdaytime']").required = "false";
                        document.querySelector("[name='Saturdaytime']").value = "";
                      //chckbox--;
                      }
                  ...
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        ...
                        <textarea rows="4" cols="80" class="form-control" name="Description" id="Description" placeholder="Vet Additional Info" ><?php print_r($snapshot->data()['Description']) ?></textarea>
                      </div>
                    </div>
                  </div>
...
<!-- Modal -->
 ...
 if(isset($_SESSION['user_id']))
 {
  ...
  print_r("<button type='button' class='btn btn-default' 
   onClick='location.href='listofvets.php' >Continue</button>
   ");}
 else if(isset($_GET['userid']))
 {
   print_r("<button type='button' class='btn btn-default' 
   onClick='location.href='listofvets.php?usertype=".$num."&userid=".$userid22."' >Continue</button>
   ");
 }
          ?>
          </div>
...
function preview(){
  ...
  <script type="module" src="../uploadvetloadevent1.js"></script>
