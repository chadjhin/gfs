      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Post Services</a>
            
            <a class='btn btn-info float-right' id='list' name='list' href="listofservices.php">Service List</a>
            </div>
...
<br/>
          ...
          <div class="card">
              ...
              <div class="card-body">
              <form action="" method="post" id="servform" name="form1">
              <div class="row">
                    <div class="col-md-12 pr-1">
                        <label style="color:red;">Service Image*</label>
              ...
              <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label style="color:red;" >Service Name*</label>
                        <input type="text" class="form-control" name="Name" id="Name" placeholder="Name" value="" required>
                      </div>
                    </div>
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label style="color:red;">Service Category*</label>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label style="color:red;">Service Price*</label>
                    ...
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="Vet" id="Vet" placeholder="Vet" value="" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label style="color:red;">Service Description*:</label>
                  ...
                  <button class="btn1 btn-info" id="uploadserv" name="button1" class="login100-form-btn" button type="submit" >
							Add Service
						</button>
