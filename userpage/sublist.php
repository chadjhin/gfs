            ...
            <ul class="navbar-nav">
              <div class="dropdown">
                ...
                <form action="sublist.php" method="post">
                  <button class="dropdown-item" name="btn1" value="1" button type="submit">My Subscription Receipts</a>
...
<?php
    ...
    $table = $db->collection($_SESSION['checkuser'])->document($_SESSION['user_id'])->collection('subscriptionlist');
        ...
        foreach ($snapshot as $document) {
          ...
          if ($document->exists()) 
          {
            ...
            print_r("
                ...
                <td class='text-right'>
                <a class='btn btn-success' href='./subreciept.php?userwebinfoid=".$userwebinfoid."&subdocid=".$document->id()."'>View</a>
                
                ");
                if($document->data()['status']!="ACTIVE")
                { ?> 
                
                <button  class="btnn btn-danger"  data-toggle="modal" data-target="#myModalreceipt"value="Click" onclick="setvar('<?php echo $documentid;?>')">
							Delete
						</button>  </td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btnn btn-danger" id="deletereceipt">Yes</button>
        </div>
      </div>
...
<!-- Modal -->
  <!-- Modal -->
  <div class="modal fade" id="myModalreceipt2" role="dialog">
    <div class="modal-dialog">
