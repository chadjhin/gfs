      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Product List</a> <br/><br/><br/>
            <?php 
            if(isset($_GET['userid']))
            {
            ...
            print_r(" <a class='btn btn-info float-right' id='add' name='add' href='postproducts.php'>Add Products</a>");
            ?>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                if(isset($_GET['userid']))
                {
                  print_r(" <h4 class='card-title' >Product List of".$_GET['userid']."</h4>");
                }
                ?> 
              </div>
...
<?php
  ...
  $table = $db->collection("$type/$iduser/$products");
        ...
        foreach ($snapshot as $document) {
          if ($document->exists()) {
            ...
            print_r("
                ...
                <tr>
                <td>
                <img id='display' style='width:50px; height:50px;' class='avatar border-gray' src='".$document->data()['prodimglink']."'onerror='this.src='../assets/img/default-avatar.png';'>
                ...
                {
                  print_r("
                <form action='productdetail.php?prodname=".$name."&userid=".$iduser."' method='post'>
              ...
              {
                print_r("
                <form action='productdetail.php?prodname=".$name."' method='post'>
                <button class='btn btn-success' type='submit' id='idbtn' name='idbtn' value='".$name."'  placeholder='more info.'>more info.</button>
                </form>
                </td>
                </tr>
