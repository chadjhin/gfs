      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Post Products</a>
            
            <a class='btn btn-info float-right' id='list' name='list' href="listofproducts.php">Product List</a>
            </div>
...
<img id="display1" src="" alt="not set" onerror="this.src='../assets/img/bg5.jpg';">
</a>
<label>Product Image 1</label></div>
                    ...
                    <div class="col-md-6 pr-1">
<div class="image"  style="height: 13rem;">
<img id="display2" src="" alt="not set" onerror="this.src='../assets/img/bg5.jpg';">
</a>
...
<label>Product Image 3</label></div>
                    ...
                    <div class="col-md-6 pr-1">
<div class="image"  style="height: 13rem;">
<img id="display4" src="" alt="not set" onerror="this.src='../assets/img/bg5.jpg';">
</a>
<label>Product Image 4</label></div>
          ...
          <div class="card">
              ...
              <div class="row">
                    <div class="col-md-6 pr-1">
                        <label style="color:red;">Product Image 1*</label>
                        <input type="file" class="form-control" name="prodimg" id="prodimg" onchange="preview1()" required>
                      
                    </div>
                    <div class="col-md-6 pr-1">
                        <label style="color:red;">Product Image 2*</label>
                        <input type="file" class="form-control" name="prodimg2" id="prodimg2" onchange="preview2()" required>
                      
                    </div>
              </div>
              <div class="row">
                    <div class="col-md-6 pr-1">
                        <label style="color:red;">Product Image 3*</label>
                        <input type="file" class="form-control" name="prodimg3" id="prodimg3" onchange="preview3()" required>
                      
                    </div>
                    <div class="col-md-6 pr-1">
                        <label style="color:red;">Product Image 4*</label>
                        <input type="file" class="form-control" name="prodimg4" id="prodimg4" onchange="preview4()" required>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="Stock" id="Stock" placeholder="Stock" value="" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        <label style="color:red;">Product Description*:</label>
                        <textarea rows="4" cols="80" class="form-control" name="Description" id="Description" placeholder="Your Product Description" required></textarea>
                      </div>
                    </div>
                  </div>
                  <button class="btn1 btn-info" id="uploadprod" name="button1" value="petstore" class="login100-form-btn" button type="submit" >
							Add Product
						</button>
...
function back(){
  ...
  display1.src="../assets/img/bg5.jpg";
  display2.src="../assets/img/bg5.jpg";
  display3.src="../assets/img/bg5.jpg";
  display4.src="../assets/img/bg5.jpg";
