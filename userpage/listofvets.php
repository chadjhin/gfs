      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Veterinarian List</a> <br/><br/><br/>
            <?php 
            if(isset($_GET['userid']))
            {
            ...
            print_r(" <a class='btn btn-info float-right' id='add' name='add' href='postvets.php'>Add Vets</a>");
            ?>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Veterinarian List</h4> 
              </div>
...
<?php
  ...
  $table = $db->collection("$type/$iduser/$vets");
        ...
        foreach ($snapshot as $document) {
          if ($document->exists()) {
            ...
            print_r("
                ...
                <tr>
                <td>
                <img id='display' style='width:50px; height:50px;' class='avatar border-gray' src='".$document->data()['vetimglink']."'onerror='this.src='../assets/img/default-avatar.png';'>
                ...
                {
                print_r("
                <form action='vetdetail.php?prodname=".$name."&userid=".$iduser."' method='post'>
              ...
              {
                print_r("
                <form action='vetdetail.php?prodname=".$name."' method='post'>
                <button class='btn btn-success' type='submit' id='idbtn' name='idbtn' value='".$name."'  placeholder='more info.'>more info.</button>
                </form>
                </td>
                </tr>
    ...
    else { echo "<p class='text-black text-center bg-danger'>Vet list is empty!<p>"; }
