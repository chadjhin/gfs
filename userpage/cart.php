      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <!--<a class='btn btn-success' style='float:right; margin:30px;' href='payed.php'>Paid</a>-->
            <div class="nav-tab">
  <a class="nav-item" href='payed.php'>View Cart History</a>
</div>
    ...
    $table = $db->collection('Petlover');
      ...
      <th >Type</th>
              ...
              foreach ($snapshot as $document) {
                  ...
                  //echo  $petloveremail ;
                  $table2 = $db->collection('Petlover')->document($petloveremail)->collection('cart');
                  ...
                  foreach ($snapshot2 as $document2) {
                    ...
                    if ($document2->exists() && $webid==$iduser &&  $document2->data()['datepayed']==null) {
                      ...
                      <tr>
                      <td>
                <img id='display' style='width:50px; height:50px;' class='avatar border-gray' src='".$document2->data()['cartlink']."'onerror='this.src='../assets/img/default-avatar.png';'>
