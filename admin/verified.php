      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Verified Accounts</a>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <?php
                if(($_GET['usertype']=="vetclinic"&&($_GET['buttontype']=="Approved"))||$_POST['btn1']){
                  echo '
                  <a class="navbar-brand" href="#pablo">Vet Clinic Approved Verification Request</a>';
                  
                }
                else if(($_GET['usertype']=="petstore"&&($_GET['buttontype']=="Approved"))||$_POST['btn2']){
                  echo '
                  <a class="navbar-brand" href="#pablo">Pet Store Approved Verification Request</a>';
                }
                else{
                  echo '
                  <a class="navbar-brand" href="#pablo">Vet Clinic Approved Verification Request</a>';
      ...
      foreach ($snapshot as $document) {
        if ($document->exists()) {
          ...
          if ($snapshotdoc->exists()) {
            if($snapshotdoc->data()['status']=='APPROVED')
{
                print_r("
              <tbody>
              <tr>
