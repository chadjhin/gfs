      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Add Endagered Pets</a>
        ...
        <div class="row" >
          ...
          <div class="card">
              <div class="card-header">
                ...
                <h5 class="title">Add Endagered Pet:</h5>
              </div>
              <div class="card-body">
              ...
              <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Endagered Pet</label>
                        <input type="text" class="form-control" name="Name" id="Name" placeholder="Name" value="" required>
                      </div>
                    </div>
                  </div>
                  
                  <button class="btn1 btn-info" id="uploadendangeredpet" name="button1" value="" class="login100-form-btn" button type="submit" >
							Add
						</button>
