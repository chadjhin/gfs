      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Declined Documents</a>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <?php
                if(($_GET['usertype']=="vetclinic"&&($_GET['buttontype']=="Declined"))||$_POST['btn1']){
                  echo '
                  <a class="navbar-brand" href="#pablo">Vet Clinic Declined Verification Request</a>';
                  $num = "vetclinic";
                }
                else if(($_GET['usertype']=="petstore"&&($_GET['buttontype']=="Declined"))||$_POST['btn2']){
                  echo '
                  <a class="navbar-brand" href="#pablo">Pet Store Declined Verification Request</a>';
                   $num = "petstore";
                }
                else{
                  echo '
...
<?php
    ...
    if(empty($_POST)&&(($_GET['usertype']=="petstore")))
    {
      ...
      foreach ($snapshot as $document) {
        if ($document->exists()) {
          ...
          if ($snapshotdoc->exists()) {
            if($snapshotdoc->data()['status']=='DECLINED')
{
                print_r("
              <tbody>
              <tr>
      ...
      <th >Owners Name</th>
              ...
              foreach ($snapshot as $document) {
                if ($document->exists()) {
                  ...
                  $subsRef = $db->collection('petstore')->document($userwebinfoid)->collection('documents')->document('docufiles');
                  $snapshotdoc = $subsRef->snapshot();
                    ...
                    if($snapshotdoc->data()['status']=='DECLINED')
        {
                      ...
                      <td class='text-right'>
                      <a class='btn btn-success' href='./uploaddoc.php?userwebinfoid=".$userwebinfoid."&&subdocid=&&checkuser=".$usertypeweb."'>View Documents</a>
                      <button style='float:right; margin-left:10px;' class='btn btn-danger' button type='submit' data-toggle='modal' data-target='#myModalpt'>
                      Delete
                    </button>
                      </td>
                      </tr>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btnn btn-danger" id="deletedoc22">Yes</button>
        </div>
      </div>
...
<!-- Modal -->
  <!-- Modal -->
  <div class="modal fade" id="myModaldoc22" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Successfully deleted this document!</p>
        </div>
        <div class="modal-footer">
        
   <button type='button' class='btn btn-default' 
   onClick="location.href='declined.php'" >Continue</button>
...
var docu = "<?php echo $userwebinfoid ; ?>";
