...
var Time = document.querySelector("[name='Sundaytime']").value;
...
const imageref2 = doc(db, col, docu, docs, docfile); // reference to the created product document
